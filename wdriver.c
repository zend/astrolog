...
LScale:
  ...
  case cmdDocDefault:
    WinExec("NOTEPAD ASTROLOG.DAT", SW_SHOW);
    break;

  case cmdDocSummary:
    WinExec("NOTEPAD FILE_ID.DIZ", SW_SHOW);
    break;

  case cmdDocReadme:
    WinExec("NOTEPAD README.540", SW_SHOW);
    break;

  case cmdDocUpdate:
    WinExec("NOTEPAD UPDATE.540", SW_SHOW);
    break;

  case cmdDocHelpfile:
    WinExec("WRITE HELPFILE.540", SW_SHOW);
    break;

  case cmdDocHomepage:
    WinExec("START ASTROLOG.URL", SW_SHOW);
    break;
